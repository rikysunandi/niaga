$(document).ready(function () {
        ...
        buttons: [
            ...
            { 
              ...
              action: function ( e, dt, node, config ) {
                  ...
                  window.open("../controller/pemeriksaan_lpb/expCSVBlmPemeriksaanLPB.php?unitup="+$('#sel_unitup').val()+'&koordinat='+$('#sel_koordinat').val()+'&tagging='+$('#sel_tagging').val() );
              }
    ...
    $('#btn_cari').click(function(btn){
        ...
        $('#map').remove();
        container.append('<div id="map"></div>');
        table.ajax.url( '../controller/pemeriksaan_lpb/getBlmPemeriksaanLPB.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&koordinat='+$('#sel_koordinat').val()+'&tagging='+$('#sel_tagging').val() ).load();
    });
