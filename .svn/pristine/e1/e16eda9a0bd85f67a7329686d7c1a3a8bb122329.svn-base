                                ...
                                <div class="mb-4">
                                    <form action="#">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mb-2 mr-4" style="display:none;">
                                            ...
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_kelancaran" title="LANCAR BAYAR" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="Y">LANCAR</option>
                                                    <option value="T">TIDAK LANCAR</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_dlpd_6" title="TDK BELI TOKEN > 6BLN" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="Y">TDK BELI TOKEN > 6BLN</option>
                                                    <option value="T">BELI TOKEN 6BLN TERAKHIR</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_blocking_token" title="BLOCKING TOKEN" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="Y">SUDAH DIBLOCKING</option>
                                                    <option value="T">BLM DIBLOCKING</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_koordinat" title="KOORDINAT" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="Y">ADA KOORDINAT</option>
                                                    <option value="T">TIDAK ADA KOORDINAT</option>
                                                </select>
                                            </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">RPTS AWAL</th>
                                            <th class="text-center bg-primary-lighten-2">PENGURANGAN</th>
                                            <th class="text-center bg-primary-lighten-2">JML ANGS AKHIR</th>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">SUB</th>
                                            <th class="text-center bg-primary-lighten-2">CEKLOK</th>
                                            <th class="text-center bg-primary-lighten-2">TOTAL KESESUAIAN</th>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">AKURASI KOORDINAT (+-m)</th>
