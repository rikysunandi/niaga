...
<head>
    ...
    <title>Backoffice Niaga | Rekap Pemeriksaan LPB</title>
    <!-- Favicon icon -->
...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Pemeriksaan LPB</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Pemeriksaan LPB</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Pemeriksaan LPB</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                    ...
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-2 col-3">
                                                ...
                                                <select id="sel_unitupi" title="PILIH UNIT INDUK" class="form-control selectpicker show-tick" data-size="5" >
                                            ...
                                            <div class="form-group mb-2 mr-4 col-3">
                                                <label class="text-label">TGL UPLOAD</label>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_rekap_pemeriksaan_lpb" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">TGL UPLOAD</th>
                                            <th class="text-center bg-primary-lighten-2">JML PEMERIKSAAN</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-pemeriksaan-lpb.js"></script>
</body>
</html>