...
$params = array(
        ...
        array($ket_transaksi, SQLSRV_PARAM_IN),
        array($status_proses, SQLSRV_PARAM_IN),
        array($status_tmp, SQLSRV_PARAM_IN),
    );

$sql = "EXEC sp_vw_Create_Daftung_RAB_Unit @UserID = ?, @Unitupi = ?, @Unitap = ?, @Unitup = ?, @Ket_Transaksi = ?, @Status_Proses = ?, @Status_TMP = ? ";
...
// DB table to use
$table = 'NIAGA.dbo.vw_Create_Daftung_RAB_Unit';
