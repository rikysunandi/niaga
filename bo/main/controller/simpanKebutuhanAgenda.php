...
$params = array(
        ...
        array($KEBUTUHAN, SQLSRV_PARAM_IN),
        array($HARGA_SATUAN, SQLSRV_PARAM_IN),
        array($VOLUME, SQLSRV_PARAM_IN),
    );

$sql = "EXEC SP_KEBUTUHAN_AGENDA_UPDATE @NOAGENDA_INDIVIDU = ?, @JENIS = ?, @ID_KEBUTUHAN = ?, @KEBUTUHAN = ?, @HARGA_SATUAN = ?, @VOLUME = ? ";
