...
if(!sqlsrv_execute($stmt)){
    ...
    $sql = "select UNITAP, UNITUP, ULP, KODEPETUGAS, JML_RBM, JML_LANCAR, JML_BARU, JML_IRISAN, TOTAL_WO, TOTAL_RPPTL, TOTAL_RPTAG, TOTAL_RPBK from vw_Create_Rekap_Draft_WO_Pemutusan Order by UNITAP, UNITUP, KODEPETUGAS ";
    ...
    if(!sqlsrv_execute($stmt)){
        ...
        header('Content-Disposition: attachment; filename="DRAFT_WO_PEMUTUSAN_'.$unitap.'_'.$unitup.'_'.date('Ymdhis').'.csv"');
