...
$sql = "EXEC sp_vw_Create_Mon_Upload_Pelunasan @UserID = ?, @Unitupi = ?, @Unitap = ?, @Unitup = ?, @BLTH = ? ";
...
$columns = array(
    ...
    array( 'db' => 'JML_BLM_LUNAS', 'dt' => 'JML_BLM_LUNAS' ),
    array( 'db' => 'TGLBAYAR_LIST', 'dt' => 'TGLBAYAR_LIST' ),
);
