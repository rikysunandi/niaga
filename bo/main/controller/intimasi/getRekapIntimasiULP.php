...
$sql = "EXEC sp_vw_Create_Rekap_Intimasi_ULP @UserID = ?, @Unitupi = ?, @Unitap = ?, @Unitup = ?, @BLTH = ?, @Tgl_Intimasi_From = ?, @Tgl_Intimasi_To = ? ";
...
// DB table to use
$table = 'NIAGA.dbo._vw_Create_Rekap_Intimasi_ULP_'.$user;
