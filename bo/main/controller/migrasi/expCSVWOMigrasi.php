...
if(!sqlsrv_execute($stmt)){
    ...
    $sql = "select UNITAP, UNITUP, IDPEL, NAMA, KOGOL, TARIF, DAYA, KDDK, MENUNGGAK_3BLN_BERTURUT2, MENUNGGAK_6BLN_BERTURUT2, MENUNGGAK_9BLN_BERTURUT2, MENUNGGAK_12BLN_BERTURUT2, JML_MENUNGGAK, BLTH_MENUNGGAK, NOAGENDA from vw_Create_WO_Migrasi_".$user." Order by MENUNGGAK_12BLN_BERTURUT2 DESC, MENUNGGAK_9BLN_BERTURUT2 DESC, MENUNGGAK_6BLN_BERTURUT2 DESC, MENUNGGAK_3BLN_BERTURUT2 DESC, UNITUP, KDDK ";
    ...
    if(!sqlsrv_execute($stmt)){
        ...
        $columns = array("UNITAP", "UNITUP", "IDPEL", "NAMA", "KOGOL", "TARIF", "DAYA", "KDDK", "MENUNGGAK_3BLN_BERTURUT2", "MENUNGGAK_6BLN_BERTURUT2", "MENUNGGAK_9BLN_BERTURUT2", "MENUNGGAK_12BLN_BERTURUT2", "JML_MENUNGGAK", "BLTH_MENUNGGAK", "NOAGENDA");
