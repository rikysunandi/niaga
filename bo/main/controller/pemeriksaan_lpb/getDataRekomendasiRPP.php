...
$tgl_pemeriksaan_from = '2022-03-10'; //$_GET['tgl_pemeriksaan_from'];
$tgl_pemeriksaan_to = '2022-12-31'; //$_GET['tgl_pemeriksaan_to'];
$user = 'SYSTEM';
...
$sql = "EXEC sp_vw_Create_Rekomendasi_RPP @UserID = ?, @Unitupi = ?, @Unitap = ?, @Unitup = ?, @User_Input = ?, @Tgl_Pemeriksaan_From = ?, @Tgl_Pemeriksaan_To = ? ";
...
// DB table to use
$table = 'NIAGA.dbo._vw_Create_Rekomendasi_RPP_'.$unitup;
...
$columns = array(
    ...
    array( 'db' => 'REKOMENDASI_RPP',  'dt' => 'REKOMENDASI_RPP' ),
    array( 'db' => 'REKOMENDASI_PETUGAS',  'dt' => 'REKOMENDASI_PETUGAS' ),
);
