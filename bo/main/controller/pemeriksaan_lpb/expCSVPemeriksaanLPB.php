...
if(!sqlsrv_execute($stmt)){
    ...
    $sql = "select UNITUPI, UNITAP, UNITUP, IDPEL, NAMA, TARIF, DAYA, NOMOR_METER_KWH, CONVERT(VARCHAR, TGL_PEMERIKSAAN, 120), PERUNTUKAN, EMAIL, SISA_KWH, LATITUDE, LONGITUDE, AKURASI_KOORDINAT, ADA_FOTO_METER, ADA_FOTO_RUMAH, USER_INPUT from vw_Create_Pemeriksaan_LPB_Unit_".$unitup;
    ...
    if(!sqlsrv_execute($stmt)){
        ...
        $columns = array( "UNITUPI", "UNITAP", "UNITUP", "IDPEL", "NAMA", "TARIF", "DAYA", "NOMETER", "TGL_PEMERIKSAAN", "RBM PASKA", "KONDISI METER", "SISA_KWH", "LATITUDE", "LONGITUDE", "AKURASI_KOORDINAT", "FOTO METER", "FOTO RUMAH", "USER_INPUT");
