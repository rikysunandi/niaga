...
// DB table to use
$table = 'NIAGA.dbo.vw_Create_Detail_RPP_Onsite_'.$user;
...
$columns = array(
    ...
    array( 'db' => 'PETUGAS_ONDESK',  'dt' => 'PETUGAS_ONDESK' ),
    array( 'db' => 'RPP_ONDESK',  'dt' => 'RPP_ONDESK' ),
    array( 'db' => 'KDDK_ONDESK',  'dt' => 'KDDK_ONDESK' ),
);
