...
$sql = "EXEC sp_vw_Create_Rekap_Foto_Rumah_UP @UserID = ?, @Unitupi = ?, @Unitap = ?, @Unitup = ?, @User_Input=?, @Tgl_Pemeriksaan_From = ?, @Tgl_Pemeriksaan_To = ? ";
...
// DB table to use
$table = 'NIAGA.dbo.vw_Create_Rekap_Foto_Rumah_UP_'.$unitup;
