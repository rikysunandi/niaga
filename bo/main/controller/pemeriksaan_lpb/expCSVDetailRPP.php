...
if(!sqlsrv_execute($stmt)){
    ...
    $sql = "select UNITUPI, UNITAP, UNITUP, IDPEL, NAMA, KOGOL, TARIF, DAYA, NAMA_GARDU, NOMOR_JURUSAN_TIANG, RPP_KDDK, RPP_PETUGAS, LATITUDE, LONGITUDE, NOMOR_METER_KWH from vw_Create_Detail_RPP_".$unitup;
    ...
    if(!sqlsrv_execute($stmt)){
        ...
        header('Content-Disposition: attachment; filename="DETAIL_RPP_'.$petugas.'_'.$rpp.'_'.date('Ymdhis').'.csv"');
