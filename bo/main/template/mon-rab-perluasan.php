...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring RAB Perluasan</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring RAB Perluasan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="mb-4">
                                    <form action="#">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_status_pengisian" title="STATUS PENGISIAN" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="SUDAH ISI">SUDAH ISI RAB</option>
                                                    <option value="BELUM ISI">BELUM ISI RAB</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_jenislap" title="JENIS AGENDA" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-rab-perluasan.js"></script>
</body>
</html>