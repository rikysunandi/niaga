...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Acuan Perhitungan Material</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Acuan Material</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_acuan_material" class="table table-striped table-bordered stripe nowrapp" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>KATEGORI</th>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/acuan-material.js"></script>
</body>
</html>