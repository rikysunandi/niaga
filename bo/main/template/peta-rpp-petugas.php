...
<head>
    ...
    <title>Backoffice Niaga | Peta RPP per Petugas</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Peta RPP Petugas</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">RPP Final</a>
                            </li>
                            <li class="breadcrumb-item active">Peta RPP</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">NO METER</th>
                                        </tr>
                                    </thead>
                                    <!-- <tfoot>
                                        <tr>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Peta RPP</h4>
                            </div>
                            <div class="card-body">
                                <!-- <div>
