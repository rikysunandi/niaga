            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    ...
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Monitoring Saldo Tunggakan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Saldo UP3 Non Kogol 1</h4>
                            </div>
                            <div class="card-body">
                                <!-- <h4 class="card-title mb-4">Rekap Pelunasan per Tgl Bayar</h4> -->
                                <div class="table-responsive">
                                    <table id="tbl_rekap_unitap" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">UNIT</th>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">NAMA</th>
                                            <th colspan="4" class="text-center bg-primary-lighten-2">TUL III-07 + SALDO BULAN LALU</th>
                                            <th rowspan="2" class="text-center bg-danger-lighten-2">TARGET</th>
                                            <th colspan="4" class="text-center bg-primary-lighten-2">SALDO H-1</th>
                                            <th colspan="4" class="text-center bg-primary-lighten-2">SALDO KINI</th>
                                            <th colspan="4" class="text-center bg-primary-lighten-2">REALISASI (PLG)</th>
                                            <th colspan="2" class="text-center bg-primary-lighten-2">REALISASI (%)</th>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">WAKTU UPDATE</th>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">TGL NIHIL</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center bg-success-lighten-2">1L</th>
                                            <th class="text-center bg-warning-lighten-2">2L</th>
                                            <th class="text-center bg-danger-lighten-2">>= 3L</th>
                                            ...
                                            <th class="text-center bg-danger-lighten-2">>= 3L</th>
                                            <th class="text-center bg-primary-lighten-2">RUPIAH</th>
                                            <th class="text-center bg-primary-lighten-2">HARI INI</th>
                                            <th class="text-center bg-primary-lighten-2">BULAN INI</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Saldo ULP Non Kogol 1</h4>
                            </div>
                            <div class="card-body">
                                <!-- <h4 class="card-title mb-4">Rekap Pelunasan per Tgl Bayar</h4> -->
                                <div class="table-responsive">
                                    <table id="tbl_rekap_unitup" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">UNIT</th>
                                            <th rowspan="2" class="text-center bg-primary-lighten-2">NAMA</th>
