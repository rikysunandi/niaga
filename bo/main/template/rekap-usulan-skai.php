...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Lampiran Formulir I</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Lampiran Formulir I</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_formulir_1" class="table table-striped table-bordered stripe nowrap" style="width: 90%">
                                    <thead>
                                        <tr>
                                            <th class="text-center bg-primary-lighten-2" rowspan="2">TARIF</th>
                                            <th class="text-center bg-primary-lighten-2" rowspan="2">NO</th>
                                            <th class="text-center bg-primary-lighten-2" rowspan="2">KET GOL TARIF</th>
                                            <th class="text-center bg-primary-lighten-2" colspan="3">KONSUMEN INDIVIDU<br/>450 DAN 900 VA TANPA PERLUASAN</th>
                                            <th class="text-center bg-primary-lighten-2" colspan="3">KONSUMEN INDIVIDU<br/>BP > INVESTASI</th>
                                            <th class="text-center bg-primary-lighten-2" colspan="3">KONSUMEN KOLEKTIF<br/>TOTAL BP > TOTAL INVESTASI</th>
                                            <th class="text-center bg-primary-lighten-2" colspan="3">KONSUMEN<br/>BP < INVESTASI</th>
                                        </tr>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-usulan-skai.js"></script>
</body>
</html>