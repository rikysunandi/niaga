...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring Potensi</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring Potensi</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4">
                                    <form action="#">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_klp_plg" title="KLP PELANGGAN" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                                    <option value="NON_GE">PELANGGAN NON GE</option>
                                                    <option value="GE">PELANGGAN GE</option>
                                                    <option value="TM">PELANGGAN TM</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 mr-4">
                                                <select id="sel_jenis_transaksi" title="JENIS TRANSAKSI" class="selectpicker show-tick" data-size="5" >
                                                    <option value="00">SEMUA DATA</option>
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_potensi" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">STATUS PERMOHONAN</th>
                                        </tr>
                                    </thead>
                                    <!-- <tfoot>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-potensi.js"></script>
</body>
</html>