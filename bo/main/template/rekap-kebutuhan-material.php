...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Kebutuhan Material per Unit</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Laporan</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Kebutuhan Material per Unit</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Rekap Kebutuhan Material per UP3</h4>
                                <div class="mb-4">
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-0 mr-4">
                                                <select id="sel_klasifikasi_rab" class="selectpicker show-tick" data-width="fit" data-size="6" >
                                                    <option selected disabled>Pilih Klasifikasi RAB</option>
                                                    <option value="INDIVIDU 450 DAN 900 TANPA PERLUASAN">INDIVIDU 450 DAN 900 TANPA PERLUASAN</option>
                                                    <option value="INDIVIDU BP >= INVESTASI">INDIVIDU BP >= INVESTASI</option>
                                                    <option value="KOLEKTIF TOTAL BP > TOTAL INVESTASI">KOLEKTIF TOTAL BP > TOTAL INVESTASI</option>
                                                    <option value="BP < INVESTASI">BP < INVESTASI</option>
                                                    <option value="00">SEMUA DATA</option>
                                                </select>
                                            </div>
                                            <div class="orm-group mb-0 mr-4 text-right">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_rekap_kebutuhan" class="table table-striped table-bordered stripe nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Rekap Kebutuhan Material per ULP</h4>
                                <div class="mb-4">
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-0 mr-4">
                                                <select id="sel_klasifikasi_rab_up" class="selectpicker show-tick" data-width="fit" data-size="6" >
                                                    <option selected disabled>Pilih Klasifikasi RAB</option>
                                                    <option value="INDIVIDU 450 DAN 900 TANPA PERLUASAN">INDIVIDU 450 DAN 900 TANPA PERLUASAN</option>
                                                    <option value="INDIVIDU BP >= INVESTASI">INDIVIDU BP >= INVESTASI</option>
                                                    <option value="KOLEKTIF TOTAL BP > TOTAL INVESTASI">KOLEKTIF TOTAL BP > TOTAL INVESTASI</option>
                                            ...
                                            <div class="orm-group mb-0 mr-4 text-right">
                                                <button id="btn_cari_up" type="button" class="btn btn-sm btn-primary waves-effect waves-light">Cari <span class="btn-icon-right"><i
                                                class="fa fa-search"></i></span>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_rekap_kebutuhan_up" class="table table-striped table-bordered stripe nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th class="bg-primary-lighten-2">UNITAP</th>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-kebutuhan-material.js"></script>
</body>
</html>