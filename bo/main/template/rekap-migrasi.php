...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Migrasi LPB</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Migrasi LPB</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Migrasi LPB</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                                ...
                                <div class="mb-0">
                                    <form action="#">
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mb-2 col-3" id="week-picker-wrapper">
                                                <label class="text-label">PERIODE</label>
                                                <input id="periode_range" class="form-control week-picker" placeholder="Pilih Minggu" type="text" name="daterange">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                 ...
                 <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Rekap Migrasi LPB per UP3</h4>
                                <div>
                                </div>
                                <div class="table-responsive">
                                    <table id="tbl_rekap_migrasi" class="table table-striped table-bordered nowrap" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="3" class="text-center bg-warning-lighten-2">TARGET</th>
                                            <th colspan="2" class="text-center bg-success-lighten-2">REALISASI</th>
                                            <th colspan="2" class="text-center bg-success-lighten-2">REALISASI<br/>PLG MENUNGGAK 12BLN BERTURUT-TURUT</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center bg-warning-lighten-2">MINGGUAN</th>
                                            <th class="text-center bg-warning-lighten-2">CARRY OVER</th>
                                            <th class="text-center bg-warning-lighten-2">TOTAL</th>
                                            <th class="text-center bg-success-lighten-2">PLG</th>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-center bg-warning-lighten-2">TARGET</th>
                                            <th colspan="2" class="text-center bg-success-lighten-2">REALISASI</th>
                                            <th colspan="2" class="text-center bg-success-lighten-2">REALISASI<br/>PLG MENUNGGAK 12BLN BERTURUT-TURUT</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center bg-warning-lighten-2">HARIAN</th>
                                            <th class="text-center bg-warning-lighten-2">CARRY OVER</th>
                                            <th class="text-center bg-success-lighten-2">PLG</th>
                                            <th class="text-center bg-success-lighten-2">PERSEN</th>
                                            <th class="text-center bg-success-lighten-2">PLG</th>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-migrasi.js?time=4"></script>
</body>
</html>