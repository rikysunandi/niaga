...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Dashboard Saldo TS P2TL Anomali Paskabayar</h4>
                    ...
                    <div class="col-xl-12">
                        <div id="card_ts_p2tl" class="card">
                            <div class="card-header">
                                <h4 class="card-title mt-3">Saldo TS P2TL Paskabayar per Unit</h4>
                                <div class="table-action float-right">
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-0">
    ...
    ***********************************-->
    ...
    <script src="../js/pages/ts-p2tl-paska.js"></script>
</body>
</html>