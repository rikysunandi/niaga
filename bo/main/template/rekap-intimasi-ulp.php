...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Intimasi per ULP</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Intimasi</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Intimasi per ULP</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_intimasi_ulp" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-intimasi-ulp.js"></script>
</body>
</html>