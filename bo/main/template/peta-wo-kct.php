...
<head>
    ...
    <title>Backoffice Niaga | Peta Pembentukan WO KCT</title>
    <!-- Favicon icon -->
...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Peta Pembentukan WO KCT</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Pendukung</a>
                            </li>
                            <li class="breadcrumb-item active">Peta Pembentukan WO KCT</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Peta Pembentukan WO KCT</h4>
                            </div>
                            <div class="card-body">
                                <div class="mb-4">
                                    <p>Pastikan sudah tidak ada cluster pada tampilan Peta, lalu silahkan pilih pelanggan-pelanggan yang akan dibentuk WO KCT dengan cara memblok sekumpulan titik koordinat (tahan tombol <span class="text-primary">SHIFT + blok area</span>) atau <span class="text-primary">KLIK</span> pada masing-masing titik koordinat.
                                    </p>
                                    <p>Lalu tentukan aksi apa yang akan dilakukan terhadap titik-titik yang sudah dipilih dengan tombol-tombol berikut:
                                        <ul>
                                            ...
                                            <li><span class="text-primary">Buat WO KCT:</span> untuk membuat WO KCT dari titik-titik yang dipilih</li>
                                        </ul>
                                    </p>
                                    <!-- <p>Aturan pembentukan WO KCT:
                                        <ul>
                                            <li>Satu WO KCT berisi kurang lebih <span class="text-primary">250 pelanggan</span></li>
                                            <li>Penamaan WO KCT: mengikuti 6 karakter RBM Paska Petugas terkait, dimana karakter terakhir diisi kode hari baca yang <span class="text-primary">dimulai dari huruf H</span></li>
                                        </ul>
                                    </p> -->
                                </div>
                            ...
                            <div class="card-footer text-muted">
                                ...
                                <button id="btn_create" class="btn btn-primary waves-effect waves-light btn-sm pull-right mr-2">Buat WO KCT <span class="btn-icon-right"><i class="fa fa-check-circle"></i></span></button>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Summary RPP</h5>
                            </div>
                            <div class="card-body">
                                <div class="basic-list-group">
    ...
    ***********************************-->
    ...
    <script src="../js/pages/peta-wo-kct.js?time=6"></script>
