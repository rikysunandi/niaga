...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring Job Update Data</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Upload Data</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring Job Update Data</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                    ...
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-2 mr-4">
                                                <label class="text-label d-block">STATUS</label>
                                                <select id="sel_blth" class="selectpicker select-sm show-tick" data-size="5" data-width="fit">
                                                    <option value="01">ANTRIAN</option>
                                                    <option data-divider="true"></option>
                                                    <option value='02'>SELESAI</option>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Monitoring Job Update Data</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">FILESIZE</th>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/job-update-data.js"></script>
</body>
</html>