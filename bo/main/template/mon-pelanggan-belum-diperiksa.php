...
<head>
    ...
    <title>Backoffice Niaga | Download DIL Belum Tagging</title>
    <!-- Favicon icon -->
...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Download DIL Belum Tagging</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Pemeriksaan LPB</a>
                            </li>
                            <li class="breadcrumb-item active">Download DIL Belum Tagging</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_blm_diperiksa" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-pelanggan-belum-diperiksa.js"></script>
</body>
</html>