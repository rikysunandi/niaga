            ...
            <div class="container-fluid ">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring Log Shuntrip</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Data Shuntrip</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring Log Shuntrip</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
<!-- 
 ...
 -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Monitoring Data Log Shuntrip</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_log_shuntrip" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th class="text-center bg-primary-lighten-2">ID DEVICE</th>
                                            <th class="text-center bg-primary-lighten-2">TGL KIRIM</th>
                                            <th class="text-center bg-primary-lighten-2">TEGANGAN</th>
                                            <th class="text-center bg-primary-lighten-2">ARUS</th>
                                            <th class="text-center bg-primary-lighten-2">POWER FACTOR</th>
                                            <th class="text-center bg-primary-lighten-2">POWER</th>
                                            <th class="text-center bg-primary-lighten-2">ENERGI</th>
                                            <th class="text-center bg-primary-lighten-2">FREKUENSI</th>
                                            <th class="text-center bg-primary-lighten-2">INDIKATOR</th>
                                            <th class="text-center bg-primary-lighten-2">TGL LOG</th>
                                        </tr>
                                    </thead>
                                    <!-- <tfoot>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-log-shuntrip.js?time=3"></script>
</body>
</html>