            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Intimasi per Keterangan</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Intimasi</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Intimasi per Keterangan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group mb-2 col-3">
                                                ...
                                                <select id="sel_blth" class="selectpicker select-sm show-tick" data-size="5" data-width="fit">
                                                    ...
                                                    <option value='<?php echo date('Ym', strtotime("-2 month")) ?>'><?php echo date('Ym', strtotime("-1 month")) ?></option>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_intimasi_keterangan" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2" class="text-center bg-warning-lighten-2">JANJI BAYAR</th>
                                            <th colspan="2" class="text-center bg-danger-lighten-2">RUMAH KOSONG</th>
                                            <th colspan="2" class="text-center bg-danger-lighten-2">TIDAK KOOPERATIF</th>
                                            <th colspan="2" class="text-center bg-secondary-lighten-2">TOTAL INTIMASI</th>
                                            <th colspan="2" class="text-center bg-secondary-lighten-2">TOTAL LUNAS</th>
                                        </tr>
                                        <tr>
                                            <th class="text-center bg-success-lighten-2">INTI</th>
                                            <th class="text-center bg-success-lighten-2">LNS</th>
                                            <th class="text-center bg-success-lighten-2">INTI</th>
                                            <th class="text-center bg-success-lighten-2">LNS</th>
                                            <th class="text-center bg-success-lighten-2">INTI</th>
                                            <th class="text-center bg-success-lighten-2">LNS</th>
                                            <th class="text-center bg-warning-lighten-2">INTI</th>
                                            <th class="text-center bg-warning-lighten-2">LNS</th>
                                            <th class="text-center bg-danger-lighten-2">INTI</th>
                                            <th class="text-center bg-danger-lighten-2">LNS</th>
                                            <th class="text-center bg-danger-lighten-2">INTI</th>
                                            <th class="text-center bg-danger-lighten-2">LNS</th>
                                            <th class="text-center bg-secondary-lighten-2">INTI</th>
