                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">JML PLG<br/>SDH TAGGING</th>
                                            <th class="text-center bg-primary-lighten-2">JML DATA<br/>TAGGING</th>
                                            <th class="text-center bg-primary-lighten-2">JML PLG<br/>BLM TAGGING</th>
