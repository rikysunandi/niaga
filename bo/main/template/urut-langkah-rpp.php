...
<body>
                            ...
                            <div class="card-footer text-muted">
                                <div class="row">
                                    <div class="align-middle d-inline col-6">
                                        <span class="fa fa-info-circle"></span> Urut Langkah: dari <span id="plg_start" class="text-success">Pelanggan X</span> ke <span id="plg_end" class="text-primary">Pelanggan Y</span>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/urut-langkah-rpp.js"></script>
