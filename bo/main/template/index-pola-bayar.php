                        ...
                        <div id="pola_bayar" class="card">
                            <div class="card-body stat-widget-four" style="background-color: #135470;">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-0 pb-0 text-white">STATUS POLA BAYAR PELANGGAN</h4>
                            ...
                            <div class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div id="pola_bayar_unit_datatable" class="mt-2 mb-0 p-4"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="rbm_lancar" class="card bg-transparent">
                            <div class="card-body stat-widget-four" style="background-color: #74BCC7;">
                                <div class="media"> 
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-0 pb-0 text-white">RBM TERLANCAR</h4>
                                        <small class="text-sm text-white blth"></small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="rbm_irisan" class="card bg-transparent">
                            <div class="card-body stat-widget-four" style="background-color: #EC5B43;">
                                <div class="media"> 
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-0 pb-0 text-white">RBM TERBANYAK IRISAN</h4>
                                        <small class="text-sm text-white blth"></small>
                                    </div>
                                </div>
                            </div>
