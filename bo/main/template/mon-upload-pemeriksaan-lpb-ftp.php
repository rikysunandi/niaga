...
<head>
    ...
    <title>Backoffice Niaga | Monitoring Upload Pemeriksaan LPB</title>
    <!-- Favicon icon -->
...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring Upload Pemeriksaan LPB</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Upload Pemeriksaan LPB</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring Upload Pemeriksaan LPB</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                    ...
                                    <form action="#">
                                        <div class="form-row">
                                            <div class="form-group mb-2 col-3">
                                                ...
                                                <select id="sel_unitupi" title="UNIT INDUK" class="form-control selectpicker show-tick" data-size="5" >
                                                    <option value="00" selected>SEMUA UNIT</option>
                                                </select>
                                            </div>
                                            <div class="form-group mb-2 col-3">
                                                <label class="text-label">UP3</label>
                                                <select id="sel_unitap" title="UP3" class="form-control selectpicker show-tick" data-size="5" >
                                                    <option value="00" selected>SEMUA UNIT</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group mb-2 mr-4 col-3">
                                                <label class="text-label">TGL PROSES</label>
                                                <input id="tgl_proses_range" class="form-control input-daterange-datepicker" type="text" name="daterange">
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_mon_upload_pemeriksaan_lpb" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th class="text-center bg-primary-lighten-2">UNITUPI</th>
                                            <th class="text-center bg-primary-lighten-2">UNITAP</th>
                                            <th class="text-center bg-primary-lighten-2">TGL PROSES</th>
                                            <th class="text-center bg-primary-lighten-2">FILENAME</th>
                                            <th class="text-center bg-primary-lighten-2">JML DATA</th>
                                            <th class="text-center bg-primary-lighten-2">JML FOTO</th>
                                            <th class="text-center bg-primary-lighten-2">JML BARU</th>
                                            <th class="text-center bg-primary-lighten-2">JML DOUBLE<br/>(TGL PEMERIKSAAN BEDA)</th>
                                            <th class="text-center bg-primary-lighten-2">JML UPLOAD ULANG<br/>(TGL PEMERIKSAAN SAMA)</th>
                                            <th class="text-center bg-primary-lighten-2">KETERANGAN</th>
                                            <th class="text-center bg-primary-lighten-2">FILEPATH</th>
                                        </tr>
                                    </thead>
                                    <!-- <tfoot>
                                        <tr>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-upload-pemeriksaan-lpb-ftp.js"></script>
</body>
</html>