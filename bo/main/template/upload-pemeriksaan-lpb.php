...
<head>
    ...
    <title>Backoffice Niaga | Upload Data Pemeriksaan LPB</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card forms-card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <p class="mb-5">Upload file zip dari Priangan dengan <code> ukuran maksimal 120Mb</code>  </p>
                                    <form id="file-pemeriksaan-lpb" action="../controller/pemeriksaan_lpb/fileUploadDBPemeriksaanLPB.php" class="dropzone mb-4">
                                        <div class="fallback">
