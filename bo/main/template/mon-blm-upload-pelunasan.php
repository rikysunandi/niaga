...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_blm_upload_pelunasan" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-warning-lighten-2">BLM UPLOAD / <br/>BLM LUNAS</th>
                                            <th class="text-center bg-warning-lighten-2">TGL BAYAR <br/>BLM UPLOAD</th>
                                        </tr>
                                    </thead>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2"></th>
                                            <th class="text-center bg-warning-lighten-2"></th>
                                            <th class="text-center bg-warning-lighten-2"> </th>
                                        </tr>
                                    </tfoot>
                                </table>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-blm-upload-pelunasan.js"></script>
</body>
</html>