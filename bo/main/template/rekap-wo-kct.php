...
<head>
    ...
    <title>Backoffice Niaga | Rekap WO KCT</title>
    <!-- Favicon icon -->
...
<body>
        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles">
                    ...
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">WO KCT</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap WO KCT</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data WO KCT</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_wo_kct" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">JML WO</th>
                                            <th class="text-center bg-primary-lighten-2">JML REALISASI</th>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Peta WO KCT</h4>
                            </div>
                            <div class="card-body">
                                <!-- <div>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-wo-kct.js?time=3"></script>
