            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring WO Pemutusan</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">WO Pemutusan</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring WO Pemutusan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-3">
                                                ...
                                                <select id="sel_status" title="STATUS WO" class="selectpicker show-tick" data-size="5" >
                                                    ...
                                                    <option value="SUDAH_PUTUS">SUDAH EKSEKUSI</option>
                                                    <option value="BELUM_PUTUS">BELUM EKSEKUSI</option>
                                                </select>
                                            </div>
                                        </div>
                                    </form>
...
<!-- 
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-wo-pemutusan.js"></script>
</body>
</html>