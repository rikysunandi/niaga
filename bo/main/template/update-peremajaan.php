...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Update Peremajaan</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Update Peremajaan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <select id="sel_blth" class="selectpicker select-sm show-tick" data-size="5" data-width="fit">
                                                <option selected="selected" value='<?php echo date('Ym', strtotime("last day of next month")) ?>'><?php echo date('Ym', strtotime("last day of next month")) ?></option>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Download data Peremajaan dari AP2T</h4>
                                <p class="mb-5">Download data detail per Peremajaan ke dalam <code> format CSV</code> dan disarankan untuk pivot dan download per tanggal yang diinginkan. Jika hasil yang ditampilkan masih kosong, silahkan lakukan pencarian ulang</p>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/update-peremajaan.js?time=2"></script>
</body>
</html>