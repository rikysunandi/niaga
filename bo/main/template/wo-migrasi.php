            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>WO Migrasi LPB</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Migrasi LPB</a>
                            </li>
                            <li class="breadcrumb-item active">WO Migrasi LPB</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-4">WO Migrasi LPB</h4>
                                <div class="table-responsive">
                                    <table id="tbl_wo_migrasi" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
...
<!-- 
    ...
    ***********************************-->
    ...
    <script src="../js/pages/wo-migrasi.js?time=3"></script>
</body>
</html>