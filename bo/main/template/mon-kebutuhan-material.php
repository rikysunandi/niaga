...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring Kebutuhan Material per Unit</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Laporan</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring Kebutuhan Material per Unit</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Monitoring Kebutuhan Material per Unit</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_rekap_material" class="table table-striped table-bordered stripe nowrap" style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th class="bg-primary-lighten-2">JENIS</th>
                                                <th class="bg-primary-lighten-2">MATERIAL</th>
                                                <th class="bg-primary-lighten-2">HARGA SATUAN</th>
                                                <th class="bg-primary-lighten-2">VOLUME</th>
                                                <th class="bg-primary-lighten-2">TOTAL HARGA</th>
                                            </tr>
                                        </thead>
                                        <tbody></tbody>
                                        <tfoot>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-kebutuhan-material.js"></script>
</body>
</html>