...
<head>
    ...
    <title>Backoffice Niaga | Pemeriksaan LPB Tidak Ada Pada DIL</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Pemeriksaan LPB Tidak Ada Pada DIL</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Pemeriksaan LPB</a>
                            </li>
                            <li class="breadcrumb-item active">Pemeriksaan LPB Tidak Ada Pada DIL</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="tbl_mon_pemeriksaan_lpb_missing_dil" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">FOTO PATH</th>
                                        </tr>
                                    </thead>
                                </table>
                                </div>
