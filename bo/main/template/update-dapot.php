...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Update Daftar Potensi</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SKAI Khusus</a>
                            </li>
                            <li class="breadcrumb-item active">Update Daftar Potensi</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                ...
                                <form action="#">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group mb-2 mr-4 col-3">
                                            <label class="text-label d-flex flex-column">TGL MOHON</label>
                                            <input id="tgl_mohon_range" class="form-control input-daterange-datepicker" type="text" name="daterange">
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">Download data Potensi dari AP2T</h4>
                                ...
                                <div class="embed-responsive embed-responsive-16by9">
                                  <iframe id="dapot_ap2t" class="embed-responsive-item" src="blank.html" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <p class="mb-2">Upload file CSV hasil Download dari AP2T dengan <code> ukuran maksimal 10Mb</code>. Agenda yang diambil adalah Agenda dari Potensi Pasang Baru, Perubahan Daya, dan Sambung Kembali.</p>
                                    <input type="file" class="dropify" data-default-file="" data-max-file-size="10M" data-allowed-file-extensions="csv"/>
                            ...
                            <div class="card-footer">
                                <div class="text-right">
                                    <button id="btn_upload" type="button" class="btn btn-sm btn-primary waves-effect waves-light mt-2">Upload <span class="btn-icon-right"><i
    ...
    ***********************************-->
    ...
    <script src="../js/pages/update-dapot.js?time=<?php echo time() ?>"></script>
</body>
</html>