...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Rekap Pola Bayar per Tarif Daya</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Pelunasan Piutang</a>
                            </li>
                            <li class="breadcrumb-item active">Rekap Pola Bayar per Tarif Daya</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <!-- <h4 class="card-title mb-4">Rekap Pola Bayar per Tarif Daya</h4> -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="chart-card">
                                    <canvas id="chart_pola_bayar_tarif_daya"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/rekap-pola-bayar-tarif-daya.js"></script>
</body>
</html>