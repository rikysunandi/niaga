...
if($stmt){
	...
	while( $unit = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
		...
		$j=0;
		do{
			$api_url = 'http://10.68.35.105:8081/monitoring-pelunasan/get-detil-lunas-piutang-pss?unit-upi=53&unit-ap='.$unit['UNITAP'].'&unit-up='.$unit['UNITUP'].'&skema-bayar=NO+REGISTER&kd-gerak-keluar=SEMUA&tgl-awal=09%2F02%2F2023&tgl-akhir=10%2F02%2F2023&sort-by=idPel&sort-dir=asc&page='.($j+1).'&limit=50&id-user=8810496Z';
			//echo $api_url;
