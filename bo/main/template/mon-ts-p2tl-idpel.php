...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col p-md-0">
                        <h4>Monitoring TS P2TL per Pelanggan</h4>
                    </div>
                    <div class="col p-md-0">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">TS P2TL per Pelanggan</a>
                            </li>
                            <li class="breadcrumb-item active">Monitoring TS P2TL per Pelanggan</li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_mon_ts_p2tl_idpel" class="table table-striped table-bordered nowrap" style="width: 100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center bg-primary-lighten-2">TOTAL RUPIAH TS</th>
                                            <th class="text-center bg-primary-lighten-2">KESESUAIAN</th>
                                        </tr>
                                    </thead>
                                </table>
                                </div>
    ...
    ***********************************-->
    ...
    <script src="../js/pages/mon-ts-p2tl-idpel.js"></script>
</body>
</html>