                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    ...
                                    <form action="../controller/sorek/uploadFileSorek2.php" id="upload-sorek" class="dropzone mt-4">
                                        <div class="fallback">
                        ...
                        <div id="proses" class="card">
                            <div class="card-body">
                                ...
                                <div class="progress progress--medium">
                                  <div class="progress-bar progress-bar-striped progress-bar-animated bg-light" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 0%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
