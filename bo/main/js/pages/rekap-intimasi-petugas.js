$(document).ready(function () {
    ...
    var table = $('#tbl_intimasi_petugas')
      ...
      .DataTable( {
        ...
        //   if (data.PERSEN_LUNAS < 50) {
        //     $('td:eq(17)', row).addClass('bg-danger-lighten-2');
        //   }else if (data.PERSEN_LUNAS < 80) {
        //     $('td:eq(17)', row).addClass('bg-warning-lighten-2');
        //   }else {
        //     $('td:eq(17)', row).addClass('bg-success-lighten-2');
        //   }
        // }, 
        dom:
    ...
    $( 'body' ).on( 'click', '#btn_cari', function(btn) {
        ...
        table.ajax.url( '../controller/intimasi/getRekapIntimasiPetugas.php?unitupi='+unitupi+'&unitap='+unitap+'&unitup='+unitup+'&blth='+blth+'&tgl_intimasi_from='+tgl_intimasi_from+'&tgl_intimasi_to='+tgl_intimasi_to ).load();
    });
