$(function() {
    ...
    function loadDataDashboard(unitap){
        ...
        $.getJSON('../controller/ts_p2tl/getSaldoAwal.php?jenis_plg=PRABAYAR&unitap='+unitap, function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getRealisasi.php?jenis_plg=PRABAYAR&unitap='+unitap, function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getSaldoAkhir.php?jenis_plg=PRABAYAR&unitap='+unitap, function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-02-18&tgl_saldo=2021-02-18', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-02-18&tgl_saldo=2021-02-25', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-02-25&tgl_saldo=2021-02-25', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-02-25&tgl_saldo=2021-03-04', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-03-04&tgl_saldo=2021-03-04', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-03-04&tgl_saldo=2021-03-18', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTS.php?jenis_plg=PRABAYAR&unitap='+unitap+'&tgl_kategori=2021-03-18&tgl_saldo=2021-03-18', function(data){
            data = data.data;
            //console.log(data);
        ...
        $.getJSON('../controller/ts_p2tl/getHistoriSaldoTSUnit.php?jenis_plg=PRABAYAR&unitap='+unitap, function(data){
                    ...
                    tooltips: {
                        ...
                        callbacks: {
                            label: function(t, d) {
                                ...
                                if(isNaN(yLabel))
                                    yLabel = 0;
                                return dstLabel + ': Rp. ' + Format2d.to(yLabel)+' M';
                            },
                            footer: function(tooltipItems, data) {
                                ...
                                return 'Total: Rp. ' + Format2d.to(sum)+' M';
                            },
                        },
