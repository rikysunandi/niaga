                    ...
                    tooltips: {
                        ...
                        callbacks: {
                            label: function(t, d) {
                                ...
                                if(isNaN(yLabel))
                                    yLabel = 0;
                                return dstLabel + ': Rp. ' + Format2d.to(yLabel/1000000000.0)+' M';
                            },
                            footer: function(tooltipItems, data) {
                                ...
                                return 'Total: Rp. ' + Format2d.to(sum/1000000000.0)+' M';
                            },
                        },
                        footerFontStyle: 'small'
                    },
                    legend: {
                        position: 'bottom',
                        display: false,
