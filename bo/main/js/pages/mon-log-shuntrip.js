$(document).ready(function () {
    ...
    var table = $('#tbl_log_shuntrip')
      ...
      .DataTable( {
        ...
        "deferLoading": 1000,
        "ajax": {
            "url": '../controller/shuntrip/getLogShuntrip.php',
            "type": "POST",
            "timeout": 60000
        },
        //responsive: true,
           ...
           // { extend: 'copyHtml5', text: '<i class="fa fa-clone"></i>&nbsp;&nbsp;Copy', footer: true },
            ...
            { 
              ...
              action: function ( e, dt, node, config ) {
                  ...
                  window.open('../controller/shuntrip/expCSVLogShuntrip.php' );
              }
    ...
    table.ajax.url( '../controller/shuntrip/getLogShuntrip.php').load();
