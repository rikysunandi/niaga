$(document).ready(function () {
    ...
    $('#btn_cari').click(function(){
        ...
        $('div.content-body').block({ message: 'Mengambil data calon pelanggan kompor induksi dengan koordinat...' });
        //console.log('cari!!');
        ...
        $.getJSON( "../controller/getDataKompor.php", 
        { 
                ...
                markers.push(
                    {
                        ...
                        icon:red_house,
                        idpel: obj.idpel,
                        nama_kelurahan: obj.nama_kelurahan,
                        gardu: obj.gardu,
                        petugas: obj.nama_kelurahan,
                        rbm_paska: obj.rbm,
                    });
            });
                        ...
                        $('#btn_create').bind( "click", function() {
                            ...
                            if(selected.length>0){
                                ...
                                var dialog = bootbox.dialog({ 
                                    message: '<div class="text-center"><i class="fa fa-spin fa-spinner"></i> Menyimpan data pelanggan...</div>', 
                                    closeButton: false 
                                });
                                ...
                                $.post('../controller/batchSimpanKompor.php', 
                                { idpels:idpels }, 
                                function(res){
                                    dialog.modal('hide');
                                ...
                                bootbox.alert({
                                    message: "Silahkan pilih koordinat yang akan dijadikan target kompor induksi!",
                                    backdrop: true
                                });
                            }
