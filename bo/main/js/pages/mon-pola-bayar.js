           ...
           // { extend: 'copyHtml5', text: '<i class="fa fa-clone"></i>&nbsp;&nbsp;Copy', footer: true },
            ...
            { 
              ...
              action: function ( e, dt, node, config ) {
                  ...
                  window.open('../controller/pelunasan/expCSVPolaBayar.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&rbm='+$('#sel_rbm').val()+'&status='+$('#sel_status').val()+'&blth='+$('#sel_blth').val() );
              }
