$(document).ready(function () {
    ...
    var table = $('#tbl_wo_intimasi')
      ...
      .DataTable( {
        ...
        "deferLoading": 1000,
        "ajax": {
            "url": '../controller/pelunasan/getWOIntimasi.php',
            "type": "POST",
            "timeout": 60000
        },
        //responsive: true,
           ...
           // { extend: 'copyHtml5', text: '<i class="fa fa-clone"></i>&nbsp;&nbsp;Copy', footer: true },
            ...
            { 
              ...
              action: function ( e, dt, node, config ) {
                  ...
                  window.open('../controller/pelunasan/expCSVWOIntimasi.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&blth='+$('#sel_blth').val() );
              }
