$(document).ready(function () {
    ...
    var table = $('#tbl_mon_wo_pemutusan')
      ...
      .DataTable( {
        ...
        "deferLoading": 0,
        "ajax": {
            "url": '../controller/pemutusan/getMonWOPemutusan.php',
            "type": "POST",
            "timeout": 60000
        },
        //responsive: true,
    ...
    $( 'body' ).on( 'click', '#btn_cari', function(btn) {
        ...
        table.ajax.url( '../controller/pemutusan/getMonWOPemutusan.php?unitupi='+unitupi+'&unitap='+unitap+'&unitup='+unitup+'&petugas='+petugas+'&blth='+blth+'&status='+status ).load();
