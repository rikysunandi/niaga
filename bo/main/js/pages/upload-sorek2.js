(function($) {
    ...
    function prosesUpload(idx){
        ...
        if(idx<queueUpload.length){
            ...
            $.post('../controller/sorek/prosesSorek2.php', { filename: filename, ori_filename: ori_filename}, function(res){
               ...
               if(res.success=='true' || res.success==true){
                    ...
                    $($(progress).find('.msg')[0]).html('Update data Sorek sudah berhasil dari File '+file.name+' (Sukses: '+res.sukses+' | Gagal: '+res.gagal+' | Generate Rekap: '+res.rekap+'), silahkan cek di <a href="mon-upload-sorek.php" class="badge badge-primary" target="_blank">di sini</a> &nbsp;<i class="fa fa-check-circle text-success"></i>');
               }else{
