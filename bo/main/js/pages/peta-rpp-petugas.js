$(document).ready(function () {
    ...
    var table = $('#tbl_rpp')
      ...
      .DataTable( {
        ...
        "deferLoading": 1000,
        "ajax": {
            "url": '../controller/pemeriksaan_lpb/getDetailRPPFinal.php',
            "type": "POST",
            "timeout": 60000
        },
        //responsive: true,
           ...
           // { extend: 'copyHtml5', text: '<i class="fa fa-clone"></i>&nbsp;&nbsp;Copy', footer: true },
            ...
            { 
              ...
              action: function ( e, dt, node, config ) {
                  ...
                  window.open('../controller/pemeriksaan_lpb/expCSVDetailRPPFinal.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&petugas='+$('#sel_petugas').val()+'&rpp='+$('#sel_rpp').val() );
              }
    ...
    $('#btn_cari').click(function(){
        ...
        table.ajax.url( '../controller/pemeriksaan_lpb/getDetailRPPFinal.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&petugas='+$('#sel_petugas').val()+'&rpp='+$('#sel_rpp').val() ).load();
