$(document).ready(function () {
    ...
    var table = $('#tbl_rekomendasi_rpp')
      ...
      .DataTable( {
        ...
        "deferLoading": 1000,
        "ajax": {
            "url": '../controller/pemeriksaan_lpb/getDataRekomendasiRPP.php',
            "type": "POST",
            "timeout": 60000
        },
        //responsive: true,
    ...
    $('#btn_cari').click(function(){
        ...
        table.ajax.url( '../controller/pemeriksaan_lpb/getDataRekomendasiRPP.php?unitupi='+$('#sel_unitupi').val()+'&unitap='+$('#sel_unitap').val()+'&unitup='+$('#sel_unitup').val()+'&petugas='+$('#sel_petugas').val() ).load();
