$(document).ready(function () {
      ...
      .DataTable( {
        ...
        buttons: [
            ...
            { 
                ...
                filename: function(){
                    return 'REKAP_INTIMASI_ULP_' +  moment().format('YYYYMMDDHHmmss');
                },
                footer: false
            },
        ],
    ...
    $( 'body' ).on( 'click', '#btn_cari', function(btn) {
        ...
        table.ajax.url( '../controller/intimasi/getRekapIntimasiULP.php?unitupi='+unitupi+'&unitap='+unitap+'&unitup='+unitup+'&blth='+blth+'&tgl_intimasi_from='+tgl_intimasi_from+'&tgl_intimasi_to='+tgl_intimasi_to ).load();
    });
